...
<div class="metric-grid">
  <div><strong>78</strong><span>场新生周赛</span></div>
  <div><strong>76</strong><span>场公开可核验</span></div>
  <div><strong>588</strong><span>个题目位置</span></div>
  <div><strong>526</strong><span>道唯一题</span></div>
</div>
...
- C++17 编译：526/526。
- 至少一个可机读公开样例或合法构造通过：496 道。
- 无成对样例或样例不可机读：30 道，页面逐题明确标注，不把“未执行”写成“已通过”。
- 语料核验日期：2026-07-25。
